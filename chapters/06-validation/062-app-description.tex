...
\begin{figure}
    ...
    \includegraphics[width=0.3\textwidth]{images/app_imgs/app_permission.png} \includegraphics[width=0.3\textwidth]{images/app_imgs/app_notification.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{images/app_imgs/app_notification.png} \includegraphics[width=0.3\textwidth]{images/app_imgs/app_noanswers.png} \\
