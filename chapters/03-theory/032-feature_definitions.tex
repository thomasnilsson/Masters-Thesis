...
An alternative, a simpler definition is to use 24 hours as the maximum potential overlap. However since travels between places are not reflected in an Hour Matrix, this would lead to gaps in the data since it takes time to move between places. Ideally, both stops and moves should be used to construct the Hour Matrix, it is not at present clear how this would be done.\\
