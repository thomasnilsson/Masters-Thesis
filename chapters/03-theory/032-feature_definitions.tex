...
\begin{itemize}
    \item [Timeslot 1:] The user visits Place 1 for exactly one hour
    \item [Timeslot 2:] The user visits Place 2 for exactly one hour
    \item [Timeslot 3:] The user visits Place 1 again for exactly one hour
\end{itemize}
...
\begin{itemize}
    \item [Timeslot 1:] The user visits Place 1 and 3 for exactly half an hour each
    \item [Timeslot 2:] The user visits Place 2 for exactly one hour
    \item [Timeslot 3:] The user visits Place 1 and 3 for exactly half an hour each once again
\end{itemize}

When compared to Routine Matrix (R) it overlaps with 2 hours in total. The maximum potential overlap is 2 hours, since the minimum matrix sum is $\sum \mathsf{R} = 2$ the routine index becomes 1 (See\label{eq:routine-index-2})
